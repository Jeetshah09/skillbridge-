        ...
        <CardContent className="space-y-4">
          <form className="space-y-4" onSubmit={handleSignIn}>
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="your.email@company.com" value={form.email} onChange={(e) => setForm(f => ({...f, email: e.target.value}))} required />
            </div>
            <div className="space-y-2">
          ...
          <div className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/register/hr" className="text-primary hover:underline">
              Sign up here
            </Link>
          </div>
        </CardContent>
